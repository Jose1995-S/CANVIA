...
<title>Listado de Alumnos | Registro de Notas</title>
    <meta name="description" content="Registro de Notas del Canvia" />
...
<nav>
    <ul>
        ...
        <li class="active"><a href="listadoalumnos.view.php">Listado de Analistas</a> </li>
...
<div class="body">
    <div class="panel">
            <h4>Listado de Analistas</h4>
            <table class="table" cellspacing="0" cellpadding="0">
                <tr>
                    <th>Apellidos</th><th>Nombres</th><th>Genero</th><th>Grado</th><th>Seccion</th>
                ...
                <a class="btn-link" href="alumnos.view.php">Agregar Analista</a>
                <br><br>
